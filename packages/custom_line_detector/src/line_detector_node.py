...
class LineDetectorNode(DTROS):
    ...
    The main functionality of this node is implemented in the :py:class:`custom_line_detector.LineDetector` class.
    ...
    Configuration:
        ~line_detector_parameters (:obj:`dict`): A dictionary with the parameters for the detector. The full list can be found in :py:class:`custom_line_detector.LineDetector`.
    ...
    def image_cb(self, image_msg):
        ...
        #. Extracts the line segments in the image using :py:class:`custom_line_detector.LineDetector`
